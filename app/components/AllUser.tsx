      ...
      try {
        ...
        const data = await res.json();
         ...
         if (data.success) {
           ...
           setUsers((prev) =>
            prev.map((u) => (u.id === user.id ? {...u, idNo, firstName, lastName, course, level}: u))
          )
            ...
            >
              ...
              >
                ...
                <div className="mt-4 flex justify-end gap-2">
                  ...
                  <button className="px-4 py-2 bg-red-600 text-white rounded" onClick={() => deleteUser(selectedUser)}>
                    Delete
                  </button>
                </div>
              </motion.div>
